...
const TOPICS = [
  {
    emoji: "☕", npc: "Barista",
    ytQuery: "ordering coffee at a cafe in English conversation",
  ...
  },
  {
    ...
    ytQuery: "airport check-in English conversation",
  ...
  {
    emoji: "🍽️", npc: "Waiter",
    ytQuery: "ordering food at a restaurant in English conversation",
  ...
  },
  {
    ...
    ytQuery: "shopping in a clothing store English conversation",
  ...
  },
  {
    ...
    ytQuery: "hotel check-in English conversation",
  ...
  },
  {
    ...
    ytQuery: "at the pharmacy English conversation",
  ...
  {
    emoji: "🗺️", npc: "Local",
    ytQuery: "asking for directions in English conversation",
  ...
  {
    emoji: "💼", npc: "Colleague",
    ytQuery: "first day at work office English conversation",
  ...
  {
    emoji: "🏠", npc: "Neighbor",
    ytQuery: "meeting your neighbor small talk in English",
    scene: "미국 아파트에 새로 이사왔어요. 복도에서 옆집 이웃과 마주쳤어요.",
    starter: "Oh hi! You must be the new neighbor. I'm Sarah, I live right next door. Welcome to the building! 👋",
    systemPrompt: "You are a friendly neighbor making small talk with a Korean English learner who just moved into the apartment next door. Keep it casual and warm, respond naturally in 2-4 sentences, and ask follow-up questions to keep the chat going (where they're from, how they like the area, etc). If the learner makes a grammar or vocabulary mistake, add a correction on a new line at the very end formatted exactly like: 💡 Correction: \"[wrong]\" → \"[correct]\". Stay in character. Reply in English only.",
    phrases: [
      { en: "Nice to meet you, I just moved in.", ko: "만나서 반가워요, 저 방금 이사왔어요." },
      { en: "I live right next door.", ko: "저는 바로 옆집에 살아요." },
      { en: "How long have you lived here?", ko: "여기 얼마나 오래 사셨어요?" },
      { en: "Do you know a good place to eat around here?", ko: "이 근처에 괜찮은 식당 아세요?" },
      { en: "Is it usually this quiet around here?", ko: "여기 원래 이렇게 조용한가요?" },
      { en: "Let me know if you ever need anything.", ko: "필요한 거 있으면 언제든 말씀하세요." },
      { en: "I'm still getting used to the neighborhood.", ko: "아직 동네에 적응 중이에요." },
      { en: "What do you like most about living here?", ko: "여기 살면서 제일 좋은 점이 뭐예요?" },
      { en: "Feel free to stop by anytime.", ko: "언제든 편하게 들르세요." },
      { en: "It was so nice talking to you.", ko: "얘기 나눠서 정말 좋았어요." },
    ],
    vocab: [
      { word: "neighborhood", ko: "동네", ex: [{ en: "This is a really friendly neighborhood.", ko: "여긴 정말 정겨운 동네예요." }, { en: "I'm still exploring the neighborhood.", ko: "아직 동네를 둘러보는 중이에요." }] },
      { word: "move in", ko: "이사 오다", ex: [{ en: "We just moved in last week.", ko: "저희 지난주에 막 이사왔어요." }, { en: "When did you move in?", ko: "언제 이사 오셨어요?" }] },
      { word: "landlord", ko: "집주인", ex: [{ en: "You can call the landlord if there's an issue.", ko: "문제가 있으면 집주인한테 연락하시면 돼요." }, { en: "Our landlord lives on the first floor.", ko: "저희 집주인은 1층에 사세요." }] },
      { word: "lease", ko: "임대 계약", ex: [{ en: "Our lease ends in June.", ko: "저희 임대 계약이 6월에 끝나요." }, { en: "I need to sign the lease tomorrow.", ko: "내일 임대 계약서에 서명해야 해요." }] },
      { word: "convenient", ko: "편리한", ex: [{ en: "It's convenient to have a grocery store nearby.", ko: "근처에 마트가 있어서 편리해요." }, { en: "The subway station is very convenient.", ko: "지하철역이 정말 편리해요." }] },
    ],
    dialogues: [
      { role:'npc', en:"Oh hi! You must be the new neighbor. I'm Sarah!", ko:"어머, 안녕하세요! 새로 이사오신 분이시죠. 저는 사라예요!" },
      { role:'user', en:"Hi Sarah, nice to meet you. I just moved in.", ko:"안녕하세요 사라, 만나서 반가워요. 저 방금 이사왔어요." },
      { role:'npc', en:"Welcome! I live right next door. How are you liking it so far?", ko:"환영해요! 저는 바로 옆집 살아요. 지금까지는 어때요?" },
      { role:'user', en:"It's nice! Is it usually this quiet around here?", ko:"좋아요! 여기 원래 이렇게 조용한가요?" },
      { role:'npc', en:"Pretty much, yeah. Do you know a good place to eat around here yet?", ko:"거의 그래요. 이 근처에 괜찮은 식당은 아세요?" },
      { role:'user', en:"Not yet, I'm still getting used to the neighborhood.", ko:"아직이요, 아직 동네에 적응 중이에요." },
      { role:'npc', en:"No worries! Let me know if you ever need anything.", ko:"괜찮아요! 필요한 거 있으면 언제든 말씀하세요." },
      { role:'user', en:"Thank you so much, that's really kind.", ko:"정말 감사해요, 너무 친절하시네요." },
      { role:'npc', en:"Of course! It was so nice talking to you.", ko:"당연하죠! 얘기 나눠서 정말 좋았어요." },
    ],
  },
  {
    emoji: "🏋️", npc: "Gym-goer",
    ytQuery: "small talk at the gym in English",
    scene: "미국 헬스장에서 운동하다가 옆 기구를 쓰려는 사람과 마주쳤어요.",
    starter: "Hey, are you using this next? No worries if not, just checking! 💪",
    systemPrompt: "You are a friendly, chatty regular at the gym making casual small talk with a Korean English learner between sets. Keep it casual and encouraging, respond naturally in 2-4 sentences, and ask follow-up questions (workout routine, how long they've been coming, etc). If the learner makes a grammar or vocabulary mistake, add a correction on a new line at the very end formatted exactly like: 💡 Correction: \"[wrong]\" → \"[correct]\". Stay in character. Reply in English only.",
    phrases: [
      { en: "Are you using this next?", ko: "이거 다음에 쓰실 건가요?" },
      { en: "How often do you come here?", ko: "여기 얼마나 자주 오세요?" },
      { en: "Do you have any tips for beginners?", ko: "초보자를 위한 팁 있으세요?" },
      { en: "What's your favorite exercise?", ko: "제일 좋아하는 운동이 뭐예요?" },
      { en: "I'm trying to get back into shape.", ko: "다시 몸 만들려고 하는 중이에요." },
      { en: "Do you take any classes here?", ko: "여기서 수업 들으세요?" },
      { en: "This machine is a killer.", ko: "이 기구 진짜 힘드네요." },
      { en: "Mind if I work in with you?", ko: "번갈아 써도 될까요?" },
      { en: "Have a good workout!", ko: "운동 잘 하세요!" },
      { en: "See you around!", ko: "또 봐요!" },
    ],
    vocab: [
      { word: "work out", ko: "운동하다", ex: [{ en: "I work out three times a week.", ko: "저는 일주일에 세 번 운동해요." }, { en: "He works out every morning.", ko: "그는 매일 아침 운동해요." }] },
      { word: "routine", ko: "루틴", ex: [{ en: "What's your workout routine like?", ko: "운동 루틴이 어떻게 되세요?" }, { en: "I need to change my routine.", ko: "루틴을 좀 바꿔야겠어요." }] },
      { word: "beginner", ko: "초보자", ex: [{ en: "I'm still a beginner at this.", ko: "저 아직 이거 초보예요." }, { en: "This class is great for beginners.", ko: "이 수업은 초보자한테 딱이에요." }] },
      { word: "sore", ko: "근육통이 있는", ex: [{ en: "My legs are so sore today.", ko: "오늘 다리가 너무 아파요." }, { en: "You'll be sore tomorrow.", ko: "내일 근육통 오실 거예요." }] },
      { word: "work in", ko: "번갈아 쓰다", ex: [{ en: "Can I work in with you on this machine?", ko: "이 기구 번갈아 써도 될까요?" }, { en: "Sure, let's work in together.", ko: "네, 번갈아 써요." }] },
    ],
    dialogues: [
      { role:'npc', en:"Hey, are you using this next?", ko:"저기, 이거 다음에 쓰실 건가요?" },
      { role:'user', en:"Oh, go ahead. Mind if I work in with you?", ko:"아, 먼저 쓰세요. 번갈아 써도 될까요?" },
      { role:'npc', en:"Of course! How often do you come here?", ko:"당연하죠! 여기 얼마나 자주 오세요?" },
      { role:'user', en:"About three times a week. I'm trying to get back into shape.", ko:"일주일에 세 번 정도요. 다시 몸 만들려고 하는 중이에요." },
      { role:'npc', en:"Nice! Do you have any tips for beginners like me?", ko:"좋네요! 저 같은 초보자한테 팁 있으세요?" },
      { role:'user', en:"Just start slow. What's your favorite exercise?", ko:"천천히 시작하세요. 제일 좋아하는 운동이 뭐예요?" },
      { role:'npc', en:"Definitely squats, even though this machine is a killer.", ko:"확실히 스쿼트요, 이 기구가 진짜 힘들긴 하지만요." },
      { role:'user', en:"Haha, I feel that. Have a good workout!", ko:"하하, 공감해요. 운동 잘 하세요!" },
      { role:'npc', en:"You too, see you around!", ko:"당신도요, 또 봐요!" },
    ],
  },
  {
    emoji: "🎉", npc: "New Acquaintance",
    ytQuery: "small talk meeting new people at a party in English",
    scene: "친구 집들이 파티에 왔어요. 처음 보는 사람이 다가와서 말을 걸어요.",
    starter: "Hey! I don't think we've met — I'm Jake, a friend of Mike's. How do you know him? 🎉",
    systemPrompt: "You are an outgoing, friendly party guest making small talk with a Korean English learner at a house party. Keep it light and fun, respond naturally in 2-4 sentences, and ask casual follow-up questions (how they know the host, what they do, shared interests). If the learner makes a grammar or vocabulary mistake, add a correction on a new line at the very end formatted exactly like: 💡 Correction: \"[wrong]\" → \"[correct]\". Stay in character. Reply in English only.",
    phrases: [
      { en: "I don't think we've met.", ko: "우리 만난 적 없는 것 같아요." },
      { en: "How do you know the host?", ko: "주최자랑 어떻게 아는 사이예요?" },
      { en: "What do you do for a living?", ko: "무슨 일 하세요?" },
      { en: "That's really interesting!", ko: "그거 정말 흥미롭네요!" },
      { en: "Small world!", ko: "세상 참 좁네요!" },
      { en: "We should hang out sometime.", ko: "우리 언제 한번 만나요." },
      { en: "Can I get your number?", ko: "번호 좀 알 수 있을까요?" },
      { en: "This is a great party.", ko: "파티 정말 좋네요." },
      { en: "I love this song!", ko: "이 노래 정말 좋아해요!" },
      { en: "It was great meeting you.", ko: "만나서 정말 반가웠어요." },
    ],
    vocab: [
      { word: "host", ko: "주최자", ex: [{ en: "Who's the host of this party?", ko: "이 파티 주최자가 누구예요?" }, { en: "The host makes amazing food.", ko: "주최자가 음식을 정말 잘해요." }] },
      { word: "acquaintance", ko: "아는 사람", ex: [{ en: "He's more of an acquaintance than a friend.", ko: "그는 친구라기보다는 아는 사람이에요." }, { en: "We have a lot of mutual acquaintances.", ko: "우리는 아는 사람이 많이 겹쳐요." }] },
      { word: "small world", ko: "세상 참 좁다", ex: [{ en: "You know Mike too? Small world!", ko: "마이크도 아세요? 세상 참 좁네요!" }, { en: "Small world, we went to the same school!", ko: "세상 참 좁네요, 같은 학교를 다녔다니!" }] },
      { word: "hang out", ko: "놀다, 어울리다", ex: [{ en: "We should hang out sometime.", ko: "우리 언제 한번 만나요." }, { en: "I like hanging out with new people.", ko: "새로운 사람들이랑 어울리는 걸 좋아해요." }] },
      { word: "catch up", ko: "근황을 나누다", ex: [{ en: "Let's catch up over coffee sometime.", ko: "나중에 커피 마시면서 근황 얘기해요." }, { en: "It's been so long, we have a lot to catch up on.", ko: "너무 오랜만이라 나눌 얘기가 많네요." }] },
    ],
    dialogues: [
      { role:'npc', en:"Hey! I don't think we've met — I'm Jake.", ko:"안녕하세요! 우리 만난 적 없는 것 같아요 — 저는 제이크예요." },
      { role:'user', en:"Hi Jake, nice to meet you! How do you know the host?", ko:"안녕하세요 제이크, 만나서 반가워요! 주최자랑 어떻게 아는 사이예요?" },
      { role:'npc', en:"We went to college together. What about you?", ko:"저희 대학 동기예요. 당신은요?" },
      { role:'user', en:"We work at the same company. What do you do for a living?", ko:"저희는 같은 회사에서 일해요. 무슨 일 하세요?" },
      { role:'npc', en:"I'm a graphic designer. That's really cool that you two work together!", ko:"저는 그래픽 디자이너예요. 두 분이 같이 일한다니 멋지네요!" },
      { role:'user', en:"Yeah, small world! This is a great party, by the way.", ko:"네, 세상 참 좁네요! 그나저나 파티 정말 좋네요." },
      { role:'npc', en:"Right? I love this song too. We should hang out sometime.", ko:"그쵸? 저도 이 노래 정말 좋아해요. 우리 언제 한번 만나요." },
      { role:'user', en:"Definitely! Can I get your number?", ko:"당연하죠! 번호 좀 알 수 있을까요?" },
      { role:'npc', en:"Of course! It was great meeting you.", ko:"당연하죠! 만나서 정말 반가웠어요." },
    ],
  },
  {
    emoji: "🗣️", npc: "Alex (Friend)",
    ytQuery: "everyday small talk casual conversation in English",
    scene: "정해진 상황 없이, 새로 사귄 친구와 아무 주제로나 자유롭게 대화해요. 어떤 질문이 나올지 몰라요 — 실전처럼요!",
    starter: "Hey! So how's your day going so far? Anything fun happen? 😄",
    systemPrompt: "You are Alex, a friendly, curious native English speaker chatting casually with a Korean English learner like a real friend — this is free, unscripted small talk, NOT a fixed scenario. Jump between everyday topics unpredictably (weekend plans, weather, food, hobbies, movies/shows, pets, work, funny complaints about daily life) the way a real conversation naturally drifts. Ask lots of genuine follow-up questions, react naturally, and keep responses casual and short (2-4 sentences). If the learner makes a grammar or vocabulary mistake, add a correction on a new line at the very end formatted exactly like: 💡 Correction: \"[wrong]\" → \"[correct]\". Reply in English only.",
    phrases: [
      { en: "What have you been up to lately?", ko: "요즘 뭐하고 지내요?" },
      { en: "Any big plans for the weekend?", ko: "주말에 특별한 계획 있어요?" },
      { en: "Have you seen any good movies recently?", ko: "최근에 재밌는 영화 본 거 있어요?" },
      { en: "This weather is crazy, right?", ko: "날씨 진짜 이상하지 않아요?" },
      { en: "What do you usually do to relax?", ko: "보통 쉴 때 뭐 해요?" },
      { en: "Do you have any pets?", ko: "반려동물 키우세요?" },
      { en: "What's your favorite way to spend a day off?", ko: "쉬는 날엔 주로 뭐 하는 걸 좋아해요?" },
      { en: "I can't believe how busy this week has been.", ko: "이번 주 진짜 정신없이 바빴어요." },
      { en: "What kind of music do you like?", ko: "어떤 음악 좋아해요?" },
      { en: "Same here, honestly.", ko: "저도 솔직히 똑같아요." },
    ],
    vocab: [
      { word: "plans", ko: "계획", ex: [{ en: "Do you have any plans tonight?", ko: "오늘 밤에 계획 있어요?" }, { en: "My plans fell through.", ko: "제 계획이 무산됐어요." }] },
      { word: "relax", ko: "쉬다, 긴장을 풀다", ex: [{ en: "I just want to relax this weekend.", ko: "이번 주말엔 그냥 쉬고 싶어요." }, { en: "Reading helps me relax.", ko: "독서가 저를 편안하게 해줘요." }] },
      { word: "honestly", ko: "솔직히", ex: [{ en: "Honestly, I'm exhausted.", ko: "솔직히 저 완전 지쳤어요." }, { en: "Honestly, that sounds like a great idea.", ko: "솔직히 그거 정말 좋은 생각 같아요." }] },
      { word: "recently", ko: "최근에", ex: [{ en: "Have you traveled anywhere recently?", ko: "최근에 어디 여행 다녀오셨어요?" }, { en: "I recently started a new hobby.", ko: "최근에 새로운 취미를 시작했어요." }] },
      { word: "exhausted", ko: "지친, 기진맥진한", ex: [{ en: "I'm exhausted after this week.", ko: "이번 주 보내고 완전 지쳤어요." }, { en: "You look exhausted, are you okay?", ko: "완전 지쳐 보여요, 괜찮아요?" }] },
    ],
    dialogues: [
      { role:'npc', en:"Hey! How's your day going so far?", ko:"안녕! 오늘 하루 어때요?" },
      { role:'user', en:"Pretty good, I can't believe how busy this week has been.", ko:"꽤 좋아요, 이번 주 진짜 정신없이 바빴어요." },
      { role:'npc', en:"Ugh, I feel that. Any big plans for the weekend?", ko:"으, 공감해요. 주말에 특별한 계획 있어요?" },
      { role:'user', en:"Not really, I just want to relax. What about you?", ko:"딱히요, 그냥 쉬고 싶어요. 당신은요?" },
      { role:'npc', en:"Same here, honestly. Have you seen any good movies recently?", ko:"저도 솔직히 똑같아요. 최근에 재밌는 영화 본 거 있어요?" },
      { role:'user', en:"Not yet, but I've been wanting to. What kind of music do you like?", ko:"아직이요, 근데 보고 싶긴 해요. 어떤 음악 좋아해요?" },
      { role:'npc', en:"I'm really into indie music lately. Do you have any pets?", ko:"요즘 인디 음악에 푹 빠졌어요. 반려동물 키우세요?" },
      { role:'user', en:"Yeah, I have a cat! This weather is crazy, right?", ko:"네, 고양이 한 마리 키워요! 날씨 진짜 이상하지 않아요?" },
      { role:'npc', en:"Totally! It's been so unpredictable lately.", ko:"완전요! 요즘 날씨 정말 종잡을 수가 없어요." },
    ],
  },
];
