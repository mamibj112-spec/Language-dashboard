...
function openNoteForm(editId) {
  ...
  box.innerHTML = `
    <div class="card">
      ...
      <label class="complete-btn" style="display:block;text-align:center;background:rgba(255,255,255,0.08);cursor:pointer;margin-top:8px;">
        📎 문서 첨부 (워드·PPT·엑셀·PDF)
      ...
      <div style="display:flex;gap:8px;margin-top:12px;">
        ...
        <button class="complete-btn" onclick="closeNoteForm()" style="background:rgba(255,255,255,0.08);">취소</button>
      </div>
    </div>`;
  renderMediaFormPreview();
...
function renderCompanyDashboard() {
  ...
  el.innerHTML = `
    ...
    <div class="card" style="margin-top:10px;">
      ...
      ${recentHtml}
      <button class="complete-btn" onclick="switchTab('notes')" style="margin-top:4px;background:rgba(255,255,255,0.08);">📒 전체 기록 보러가기</button>
    </div>`;
}
